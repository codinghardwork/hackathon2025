...
//     let slingOptions = { density: 0.004 };
//     let sling = Matter.Bodies.polygon(250,250,8,20, slingOptions);

//     let elastic = Matter.Constraint.create({
//         pointA: { x: 250, y: 250},
//         bodyB: RemotePlayback,
//         stifness: 0.05,
//         length: 0.5
//     });

//     Matter.Composite.add(engine.world, [ground, sling, elastic]);
...
//         if (event.body == sling) firing = true;
//     });

//     Matter.Events.on(engine, 'afterUpdate', function() {
//         if (firing && Math.abs(sling.position.x-250) < 20 && Math.abs(sling.position.y-250) < 20) {

//             sling = Matter.Bodies.polygon(250, 250, 7, 20, slingOptions);
//             Matter.Composite.add(engine.world, sling);
//             elastic.bodyB = sling;
//             firing = false;
//         }
//     });
